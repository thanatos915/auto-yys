import cv2,numpy,time,random, time
...
def select_mode():
    ...
    mode = [0, card, yuhun, yeyuanhuo, goliang, solo, hun]
    comand = mode[index]
    comand()
...
def hun():
    while True:
        ...
        # screen = ImageGrab.grab((100, 120, 1500, 1000))
        ...
        # 自动点击通关结束后的页面
        for i in ['ying','jiangli', 'tiaozhan', 'jieshou', 'jieshou2']:
        # for i in ['tiaozhan']:
            want = imgs[i]
            size = want[0].shape
            h, w, ___ = size
